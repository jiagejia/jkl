	...
	if ($_SERVER['REQUEST_METHOD'] != 'POST') {
        ...
        if (isset($_POST['url']) && $_POST['url']!="" ) {
            ...
            if(preg_match('/^(data:\s*image\/(\w+);base64,)/',$headPortrait,$res)){
                ...
                $absnewImageFile = "http://api.hzbiz.net/0103/api/".$newImageFile;
...
//            $sql = "INSERT INTO news (title, msg , imgurl)  VALUES ('$title','$content','$absnewImageFile')";
        $sql = "INSERT INTO `blogs`(`title`, `body`, `username`, `ctime`, `city`,`url`) VALUES ('$title','$body','$username','$ctime','$city','$absnewImageFile')";
